...
$string['enrol_period_desc'] = 'مدتی زمانی که کاربران در درس ثبت نام باقی می مانند. مقدار صفر به معنی نامحدود می‌باشد.';
...
$string['error_status'] = 'فعال سازی روش ثبت نام سبد خرید بدون حساب پرداخت امکان پذیر نمی‌باشد.';
